...
public class QUserQuizAnswer extends EntityPathBase<UserQuizAnswer> {
    ...
    private static final long serialVersionUID = -650450628L;
    ...
    public final com.example.cs25entity.domain.user.entity.QUser user;
    ...
    public QUserQuizAnswer(Class<? extends UserQuizAnswer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.cs25entity.domain.user.entity.QUser(forProperty("user"), inits.get("user")) : null;
    }
