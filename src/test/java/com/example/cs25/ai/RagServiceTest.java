...
class RagServiceTest {
    ...
    void insertDummyDocumentsAndSearch() {
        ...
        Document doc1 = new Document("운영체제에서 프로세스와 스레드는 서로 다른 개념이다. 프로세스는 독립적인 실행 단위이고, 스레드는 프로세스 내의 작업 단위다.");
        Document doc2 = new Document("TCP는 연결 기반의 프로토콜로, 패킷 손실 없이 순서대로 전달된다. UDP는 비연결 기반이며 빠르지만 신뢰성이 낮다.");
