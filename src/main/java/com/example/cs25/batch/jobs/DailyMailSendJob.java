...
public class DailyMailSendJob {
	...
	@Bean
	public Job mailJob(JobRepository jobRepository, @Qualifier("mailStep") Step mailStep) {
	...
	public Tasklet mailTasklet() {
		return (contribution, chunkContext) -> {
			...
			Set<DayOfWeek> fakeDays = EnumSet.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.THURSDAY, DayOfWeek.FRIDAY);
